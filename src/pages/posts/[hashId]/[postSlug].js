  ...
  return (
    <Layout>
      <div>
          ...
          <header className="flex flex-col md:flex-row gap-y-5 md:justify-between md:items-start mb-12 mx-auto max-w-screen-md">
            ...
            <div className="flex items-stretch">
              ...
              <div className="flex flex-col mr-4 justify-between">
                <div className="">
                  <Link
                    className="text-xs px-2 py-1 rounded-xl bg-orange-100 text-orange-600 hover:text-orange-100 hover:bg-orange-600 transition-all duration-300 cursor-pointer mr-5"
                    href={`/blogs/${post.category.englishTitle}`}
                  >
                    {post.category.title}
                  </Link>
                  <span className="font-extrabold text-base ">Emad</span>
                </div>
        ...
        prose-img:rounded-xl prose-a:text-orange-500 mb-8 max-w-screen-md  mx-auto prose-p:text-justify
        "
          >
            <h1>{post.title}</h1>
...
`}</pre>
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-6 gap-10">
              <PostList blogsData={post.related} className={"500px"} />
            </div>
          </section>
          {/* post comments */}
